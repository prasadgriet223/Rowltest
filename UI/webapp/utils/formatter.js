sap.ui.define([], function () {
	...
	return {
		...
		jobsSCMURL: function (scmUrl) {
			if (scmUrl !== null && scmUrl !== undefined) {
				return scmUrl.substring(scmUrl.lastIndexOf("/") + 1, scmUrl.length);
			}
		},
		...
		addDeselectOption: function () {
			...
			this.getBinding("items").attachDataReceived(function () {
				that.insertItem(new sap.ui.core.ListItem({
					text: '',
					key: undefined
				}), 0);
			});
