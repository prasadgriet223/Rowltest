	...
	return UIComponent.extend("scp.com.saparate.Component", {
		...
		init: function () {
			...
			if ( domainName === "p2001579154trial" || domainName === "webidetesting4718256" || host.startsWith("roqa-poc-")) {
				sap.ui.getCore().getModel('oKeyModel').setProperty("/saparate/domain", "na2.saparate.com");
			} else if ( domainName === "p2001885952trial" || host.startsWith("rodemo-demo-")) {
				sap.ui.getCore().getModel('oKeyModel').setProperty("/saparate/domain", "pg.saparate.com");
			} else if (host.startsWith("roqa-dev-")  || domainName === "webidetesting4716335"   ) {
				sap.ui.getCore().getModel('oKeyModel').setProperty("/saparate/domain", "na3.saparate.com");
			}
		...
		//	test code
			...
			// 	"authorizationToken": "43cac0a5-2935-44a0-9532-ff482aba5180"
			// });
